...
public class MerchantLocationWeeklyPerformanceMetric {
  ...
  public MerchantLocationWeeklyPerformanceMetric period(LocalDate period) {
    this.period = period;
    return this;
  }
  ...
  **/
  ...
  public MerchantLocationWeeklyPerformanceMetric totalNumberOfTrxs(Long totalNumberOfTrxs) {
  ...
  **/
  ...
  public MerchantLocationWeeklyPerformanceMetric totalTrxsSpend(Double totalTrxsSpend) {
  ...
  **/
  ...
  public MerchantLocationWeeklyPerformanceMetric brickPctSpend(Double brickPctSpend) {
  ...
  **/
  ...
  public MerchantLocationWeeklyPerformanceMetric brickPctTrxs(Double brickPctTrxs) {
  ...
  **/
  ...
  public MerchantLocationWeeklyPerformanceMetric creditPctSpend(Double creditPctSpend) {
  ...
  **/
  ...
  public MerchantLocationWeeklyPerformanceMetric creditPctTrxs(Double creditPctTrxs) {
  ...
  **/
  ...
  public MerchantLocationWeeklyPerformanceMetric debitPctSpend(Double debitPctSpend) {
  ...
  **/
  ...
  public MerchantLocationWeeklyPerformanceMetric debitPctTrxs(Double debitPctTrxs) {
  ...
  **/
  ...
  public MerchantLocationWeeklyPerformanceMetric onlinePctSpend(Double onlinePctSpend) {
  ...
  **/
  ...
  public MerchantLocationWeeklyPerformanceMetric onlinePctTrxs(Double onlinePctTrxs) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MerchantLocationWeeklyPerformanceMetric merchantLocationWeeklyPerformanceMetric = (MerchantLocationWeeklyPerformanceMetric) o;
    return Objects.equals(this.period, merchantLocationWeeklyPerformanceMetric.period) &&
        Objects.equals(this.totalNumberOfTrxs, merchantLocationWeeklyPerformanceMetric.totalNumberOfTrxs) &&
        Objects.equals(this.totalTrxsSpend, merchantLocationWeeklyPerformanceMetric.totalTrxsSpend) &&
        Objects.equals(this.brickPctSpend, merchantLocationWeeklyPerformanceMetric.brickPctSpend) &&
        Objects.equals(this.brickPctTrxs, merchantLocationWeeklyPerformanceMetric.brickPctTrxs) &&
        Objects.equals(this.creditPctSpend, merchantLocationWeeklyPerformanceMetric.creditPctSpend) &&
        Objects.equals(this.creditPctTrxs, merchantLocationWeeklyPerformanceMetric.creditPctTrxs) &&
        Objects.equals(this.debitPctSpend, merchantLocationWeeklyPerformanceMetric.debitPctSpend) &&
        Objects.equals(this.debitPctTrxs, merchantLocationWeeklyPerformanceMetric.debitPctTrxs) &&
        Objects.equals(this.onlinePctSpend, merchantLocationWeeklyPerformanceMetric.onlinePctSpend) &&
        Objects.equals(this.onlinePctTrxs, merchantLocationWeeklyPerformanceMetric.onlinePctTrxs);
  }

  @Override
  public int hashCode() {
    return Objects.hash(period, totalNumberOfTrxs, totalTrxsSpend, brickPctSpend, brickPctTrxs, creditPctSpend, creditPctTrxs, debitPctSpend, debitPctTrxs, onlinePctSpend, onlinePctTrxs);
  }
  ...
  public String toString() {
    ...
    sb.append("class MerchantLocationWeeklyPerformanceMetric {\n");
